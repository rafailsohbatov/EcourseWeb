...
<label class="lblDesign">Address</label> <input type="text" placeholder="Phone" id="addressId"> <br>
<label class="lblDesign">Phone</label> <input type="text" placeholder="Phone" id="phoneId"> <br>
<label class="lblDesign">Work-Experience</label> <input type="text" placeholder="Work-Experience" id="workExperienceId"> <br>
